...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="{{ asset('public/theme/') }}/vendors/choices/choices.min.css" rel="stylesheet">
...
<body class="{{ $class ?? '' }}">
            ...
            <div class="content">
                ...
                <div class="card mb-3">
                    <div class="bg-holder d-none d-lg-block bg-card"
                        style="background-image:url({{ asset('public/theme/') }}/assets/img/illustrations/corner-4.png);">
                    </div>
                    <!--/.bg-holder-->
                            ...
                            <div class="col-lg-8">
                                ...
                                <nav style="--falcon-breadcrumb-divider: '»';" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        {{ @$breadcrumb }}
                                        <li class="breadcrumb-item active" aria-current="page"> {{ $header }}
                                        </li>
                                    </ol>
                                </nav>
                ...
                <footer>
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">{{ date('Y') }}© Al Hoor Commercial Brokerage LLC <span
                                    class="d-none d-sm-inline-block"> </span><br class="d-sm-none" /> </p>
                        </div>
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">Design and Develop By Al Hoor </p>
                        </div>
                    </div>
                </footer>
            </div>
                ...
                <div class="modal-header modal-header-settings bg-shape">
                    <div class="z-index-1 py-1 light">
                        <h5 class="text-white" id="settings-modal-label"> <span
                                class="fas fa-palette me-2 fs-0"></span>Settings</h5>
                ...
                <div class="modal-body px-card" id="themeController">
                        ...
                        <div class="row gx-2">
                            <div class="col-6">
                                ...
                                <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                                        class="hover-overlay mb-2 rounded d-block"><img
                                            ...
                                            src="{{ asset('public/theme/') }}/assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span
                            ...
                            <div class="col-6">
                                ...
                                <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                        class="hover-overlay mb-2 rounded d-block"><img
                                            class="img-fluid img-prototype mb-0"
                                            src="{{ asset('public/theme/') }}/assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-start"><img class="me-2"
                                src="{{ asset('public/theme/') }}/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
                            <div class="flex-1">
                    ...
                    <hr />
                    <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-start"><img class="me-2" src="{{ asset('public/theme/') }}/assets/img/icons/arrows-h.svg"
                                width="20" alt="" />
                            <div class="flex-1">
                    ...
                    <hr />
                    <div class="d-flex align-items-start"><img class="me-2" src="{{ asset('public/theme/') }}/assets/img/icons/paragraph.svg"
                            width="20" alt="" />
                        <div class="flex-1">
                        ...
                        <div class="row gx-2">
                            <div class="col-6">
                                ...
                                <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent">
                                    <img class="img-fluid img-prototype" src="{{ asset('public/theme/') }}/assets/img/generic/default.png"
                            ...
                            <div class="col-6">
                                ...
                                <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted">
                                    <img class="img-fluid img-prototype" src="{{ asset('public/theme/') }}/assets/img/generic/inverted.png"
                            ...
                            <div class="col-6">
                                ...
                                <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                        class="img-fluid img-prototype" src="{{ asset('public/theme/') }}/assets/img/generic/card.png" alt="" /><span
                            ...
                            <div class="col-6">
                                ...
                                <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                        class="img-fluid img-prototype" src="{{ asset('public/theme/') }}/assets/img/generic/vibrant.png"
                                        alt="" /><span class="label-text"> Vibrant</span></label>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-5"><img class="mb-4" src="{{ asset('public/theme/') }}/assets/img/illustrations/settings.png" alt=""
                            width="120" />
    ...
    <script src="{{ asset('public/theme/') }}/vendors/choices/choices.min.js"></script>
