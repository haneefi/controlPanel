    ...
    <div class="d-flex align-items-center">
        <div class="toggle-icon-wrapper">
            ...
            <div class="d-flex align-items-center py-3"><img class="me-2"
                    ...
                    class="font-sans-serif">Alhoor</span>
            </div>
        </a>
    </div>
                ...
                <li class="nav-item">
                    ...
                    @can('user_access')
                        ...
                        <ul class="nav collapse false" id="users" :show="request()->routeIs('users.*')">
                            <li class="nav-item">
                                <x-jet-nav-link class="nav-link" href="{{ route('users.index') }}">
                            ...
                            <li class="nav-item">
                                <x-jet-nav-link class="nav-link" href="{{ route('users.roles.index') }}">
                            ...
                            <li class="nav-item">
                                <x-jet-nav-link class="nav-link" href="{{ route('users.permissions.index') }}">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">
                                            {{ __('Permissions') }}
                                        </span>
                                    </div>
